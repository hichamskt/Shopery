...
function HotDeals (){
  const [rating,setRating]=useState(
    ...
    hotDealsdummydata[4].rating?.reduce((acc, rate) => acc + rate.rating, 0)/hotDealsdummydata[4].rating.length
    :0
  );
  ...
  return(
    <div className='container'>
      ...
      <div className='hotdealsBigcard'>
        {hotDealsdummydata[4].discount >0 && <p className='bigcard-hd'>Sale {hotDealsdummydata[4].discount}%</p>}
        ...
        <div className='bg-midsection'> 
          ...
          <button >Add to Cart <IoBagHandleOutline /> </button>
      <div className='bg-icons'>
      <FiEye  />
        ...
        <div className='bg-bsection'>
          ...
          {hotDealsdummydata[4].discount>0?<span className='bg-prices'><p>${hotDealsdummydata[4].price -  hotDealsdummydata[4].discount * hotDealsdummydata[4].price/100}</p><p>${hotDealsdummydata[2].price}</p></span> :<p className='bg-pricez'>${hotDealsdummydata[2].price}</p>}
        
        <div className='bg-ratingnfb'>
        <Rating rating={rating} />
        {hotDealsdummydata[4].review.length>0 && <p className='bg-feedback'>({hotDealsdummydata[4].review.length} Feedback)</p>}
        </div>
